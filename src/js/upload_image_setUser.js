...
function ImageUploader($parent, options) {
	var imageUploader = function ($parent, options) {
		var n = this;
		n.config = $.extend({}, {
				inputName: "tx_img", //input名，用于构造表单提交数据
				onlyShow: !1, //是否只查看
			...
			function upload(result) {
				...
				$.ajax({
					...
					success: function (data) {
						...
						var picUrl = '//gss0.bdstatic.com/8r1VfDn7KggZnd_b8IqT0jB-xx1xbK/static/list/img/revision/right-banner_562f509.jpg'
						...
						console.log(data);
						img[0].src = picUrl;
						var myInput =`<input hidden name ="headimgurl" value="${picUrl}">`
						context.$uploadBtn.before(myInput)
						$('.img-input').val(picUrl)
